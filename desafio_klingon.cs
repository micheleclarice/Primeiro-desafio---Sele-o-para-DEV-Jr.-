...
public class HelloWorld
{
    public static void Main(string[] args)
    {
        ...
        foreach (var word in words)
        {
            ...
            foreach (var letter in word)
            {
                number += Array.IndexOf(alfabetoKlingon, letter) * weight;
                weight *= 20;
            }
        ...
        Console.WriteLine("Numeros bonitos: {0}", qtdeNumerosBonitos);
    }
}